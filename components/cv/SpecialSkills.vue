...
<template>
  <IconLeftBorder :imgSrc="medal" title="Special Skills">
    ...
    <div class="flex flex-col mt-3">
      ...
      <span>
        Spring (Spring Boot 3 incl. Webflux and Spring Cloud), Quarkus IO, Flutter, Android,
        ...
        Prometheus, Grafana, Open Telemetry, Jaeger, Swagger / OAS, OpenAPI Generator, Zally, GCP (Google Cloud Platform),
        Google PubSub, Apache Kafka, ActiveMQ
      </span>
    </div>
    <div class="flex flex-col mt-3">
      <h2 class="font-semibold">Analysis and Performance Tools</h2>
      <span>
